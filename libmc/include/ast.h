...
enum class unary_operand { MINUS, NOT };
...
struct binary_operation : public expression {
  ...
  sptr<expression> lhs;
  sptr<expression> rhs;
  binary_operation(sptr<binary_operand> op, sptr<expression> lhs,
                   sptr<expression> rhs)
...
struct unary_operation : public expression {
  ...
  sptr<expression> sub;
  unary_operation(sptr<unary_operand> op, sptr<expression> sub)
      : op(op), sub(sub) {}
  virtual bool operator==(const node& other) const;
  virtual std::ostream& print_to(std::ostream& stream) const;
};
...
struct if_stmt : public statement {
  ...
  if_stmt(sptr<expression> condition, sptr<statement> then_stmt,
          sptr<statement> else_stmt)
      : condition(condition), then_stmt(then_stmt), else_stmt(else_stmt) {}
  if_stmt(sptr<expression> condition, sptr<statement> then_stmt)
      : if_stmt(condition, then_stmt, nullptr) {}
  virtual bool operator==(const node& other) const;
  virtual std::ostream& print_to(std::ostream& stream) const;
};
...
struct decl_stmt : public statement {
  ...
  decl_stmt(sptr<variable> var, sptr<expression> init_expr)
...
struct while_stmt : public statement {
  sptr<expression> condition;
  sptr<statement> stmt;
  while_stmt(sptr<expression> condition, sptr<statement> stmt)
...
struct function_def : public node {
  ...
  function_def(sptr<type> returnType, string name, const param_list& parameters,
               sptr<compound_stmt> body)
...
struct function_prototype : public function_def {
  function_prototype(sptr<type> returnType, string name,
                     const param_list& parameters)
      : function_def(returnType, name, parameters, nullptr) {}
  virtual bool operator==(const node& other) const;
  virtual std::ostream& print_to(std::ostream& stream) const;
};
