...
${OBJECTDIR}/_ext/29de025/ast.o: ../mC/ast.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29de025/ast.o ../mC/ast.cpp

${OBJECTDIR}/_ext/29de025/parser.o: ../mC/parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/29de025
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29de025/parser.o ../mC/parser.cpp

${OBJECTDIR}/_ext/29de025/stream_utils.o: ../mC/stream_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/29de025
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29de025/stream_utils.o ../mC/stream_utils.cpp

${OBJECTDIR}/_ext/29de025/string_utils.o: ../mC/string_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/29de025
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29de025/string_utils.o ../mC/string_utils.cpp
