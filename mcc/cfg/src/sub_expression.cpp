...
namespace mcc {
  namespace cfg {
    ...
    bool SubExpression::containsArg1() const {
      return (this->arg1 != nullptr);
    }

    bool SubExpression::containsArg2() const {
      return (this->arg2 != nullptr);
    }

    SubExpression::OperandPtr SubExpression::getArg1() const {
      return this->arg1;
    }

    SubExpression::OperandPtr SubExpression::getArg2() const {
      return this->arg2;
    }

    SubExpression::Operator SubExpression::getOperator() const {
      return this->op;
    }
