...
namespace mcc {
  namespace tac {
    ...
    TEST(Tac, SSA) {
      ...
      auto x3 = std::static_pointer_cast<Variable>(tac.codeLines[3]->arg2);
      auto x4 = std::static_pointer_cast<Variable>(tac.codeLines[4]->arg2);
      auto x5 = std::static_pointer_cast<Variable>(tac.codeLines[5]->arg1);
      auto x6 = std::static_pointer_cast<Variable>(tac.codeLines[6]->arg2);
