...
unsigned ScopeNode::getDepth() const { return this->scopeDepth; }
unsigned ScopeNode::getIndex() const { return this->scopeIndex; }

unsigned ScopeNode::getNextIndex() { return nextIndex++; }
}
}
